...
/*  42*/            return this;
            ...
            public double evaluateAsNumber(Context context)
                throws XPathException
            {
/*  50*/        return Math.floor(super.argument[0].evaluateAsNumber(context));
            }
...
/*  66*/        return super.argument[0].getDependencies();
            ...
            public Expression reduce(int i, Context context)
                throws XPathException
            {
/*  74*/        Floor floor = new Floor();
/*  75*/        floor.addArgument(super.argument[0].reduce(i, context));
/*  76*/        floor.setStaticContext(getStaticContext());
/*  77*/        return floor.simplify();
            }
}
